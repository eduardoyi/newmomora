/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 355e86cb5ac4e2cdd262344c4c7e1d6c)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	MEMORY_BOOK_PREVIEWS: R2Bucket;
	ENVIRONMENT: "staging" | "production";
	SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-memory-book-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-memory-book-bridge";
	DISPATCH_SIGNING_SECRET: string;
	SUPABASE_BRIDGE_HMAC_SECRET: string;
	OPENAI_API_KEY: string;
	MEMORY_BOOK_WORKFLOW: Workflow<Parameters<import("./src/index").MemoryBookWorkflow['run']>[0]['payload']>;
}
