/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ad902516f8e6d5e62a555542962adc5)
// Runtime types generated with workerd@1.20260730.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	SUPABASE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co" | "https://uglhonlaqkqvxcqudwlk.supabase.co";
	EXPORT_EMAIL_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/send-export-email" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/send-export-email";
	SUPABASE_ANON_KEY: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	EXPORT_EMAIL_BRIDGE_SECRET: string;
	EXPORT_WORKFLOW: Workflow /* ExportArchiveWorkflow */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		MEDIA: R2Bucket;
		SUPABASE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co";
		EXPORT_EMAIL_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/send-export-email";
		SUPABASE_ANON_KEY: string;
		SUPABASE_SERVICE_ROLE_KEY: string;
		EXPORT_EMAIL_BRIDGE_SECRET: string;
		EXPORT_WORKFLOW: Workflow /* ExportArchiveWorkflow */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "EXPORT_EMAIL_BRIDGE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "EXPORT_EMAIL_BRIDGE_SECRET">> {}
}
