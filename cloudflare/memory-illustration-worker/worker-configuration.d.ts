/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2fb83ad6bf698dc34f153605a5449af)
// Runtime types generated with workerd@1.20260721.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	MEMORY_ILLUSTRATIONS: R2Bucket;
	CHARACTER_PORTRAITS: R2Bucket;
	PROFILE_PICTURES: R2Bucket;
	STYLE_REFERENCES: R2Bucket;
	GALLERY_IMPORT_PREVIEWS: R2Bucket;
	IMAGES: ImagesBinding;
	ENVIRONMENT: "staging" | "production";
	SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-illustration-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-illustration-bridge";
	PORTRAIT_SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-portrait-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-portrait-bridge";
	GALLERY_SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-gallery-import-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-gallery-import-bridge";
	DISPATCH_SIGNING_SECRET: string;
	SUPABASE_BRIDGE_HMAC_SECRET: string;
	PORTRAIT_DISPATCH_SIGNING_SECRET: string;
	PORTRAIT_SUPABASE_BRIDGE_HMAC_SECRET: string;
	GALLERY_DISPATCH_SIGNING_SECRET: string;
	GALLERY_SUPABASE_BRIDGE_HMAC_SECRET: string;
	OPENAI_API_KEY: string;
	MEMORY_ILLUSTRATION_WORKFLOW: Workflow<Parameters<import("./src/index").MemoryIllustrationWorkflow['run']>[0]['payload']>;
	PORTRAIT_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/index").PortraitGenerationWorkflow['run']>[0]['payload']>;
	GALLERY_IMPORT_WORKFLOW: Workflow<Parameters<import("./src/index").GalleryImportWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		IMAGES: ImagesBinding;
		ENVIRONMENT: "staging";
		SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-illustration-bridge";
		PORTRAIT_SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-portrait-bridge";
		GALLERY_SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-gallery-import-bridge";
		DISPATCH_SIGNING_SECRET: string;
		SUPABASE_BRIDGE_HMAC_SECRET: string;
		PORTRAIT_DISPATCH_SIGNING_SECRET: string;
		PORTRAIT_SUPABASE_BRIDGE_HMAC_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_BRIDGE_URL" | "PORTRAIT_SUPABASE_BRIDGE_URL" | "GALLERY_SUPABASE_BRIDGE_URL" | "DISPATCH_SIGNING_SECRET" | "SUPABASE_BRIDGE_HMAC_SECRET" | "PORTRAIT_DISPATCH_SIGNING_SECRET" | "PORTRAIT_SUPABASE_BRIDGE_HMAC_SECRET" | "GALLERY_DISPATCH_SIGNING_SECRET" | "GALLERY_SUPABASE_BRIDGE_HMAC_SECRET" | "OPENAI_API_KEY">> {}
}
