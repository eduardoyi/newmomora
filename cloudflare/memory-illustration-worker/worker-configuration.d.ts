/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 886bbaa2700d1d4f10fa044b345f8936)
...
interface __BaseEnv_Env {
	...
	SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.functions.supabase.co/workflow-illustration-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-illustration-bridge";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		IMAGES: ImagesBinding;
		ENVIRONMENT: "staging";
		SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.functions.supabase.co/workflow-illustration-bridge";
		DISPATCH_SIGNING_SECRET: string;
		SUPABASE_BRIDGE_HMAC_SECRET: string;
		OPENAI_API_KEY: string;
		MEMORY_ILLUSTRATION_WORKFLOW: Workflow<Parameters<import("./src/index").MemoryIllustrationWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_BRIDGE_URL" | "DISPATCH_SIGNING_SECRET" | "SUPABASE_BRIDGE_HMAC_SECRET" | "OPENAI_API_KEY">> {}
}
