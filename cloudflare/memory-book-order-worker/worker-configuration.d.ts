/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3af2aa67f6daa19c271ee527b62a35cd)
// Runtime types generated with workerd@1.20260907.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "production";
	SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-memory-book-order-bridge" | "https://uglhonlaqkqvxcqudwlk.supabase.co/functions/v1/workflow-memory-book-order-bridge";
	PRODIGI_API_BASE_URL: "https://api.sandbox.prodigi.com";
	...
	MEMORY_BOOK_ORDER_WORKFLOW: Workflow<Parameters<import("./src/index").MemoryBookOrderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		ENVIRONMENT: "staging";
		SUPABASE_BRIDGE_URL: "https://REPLACE_WITH_STAGING_PROJECT_REF.supabase.co/functions/v1/workflow-memory-book-order-bridge";
		PRODIGI_API_BASE_URL: "https://api.sandbox.prodigi.com";
		PRODIGI_SKU: "BOOK-FE-8_3-SQ-LF-G";
		DISPATCH_SIGNING_SECRET: string;
		SUPABASE_BRIDGE_HMAC_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_BRIDGE_URL" | "PRODIGI_API_BASE_URL" | "PRODIGI_SKU" | "DISPATCH_SIGNING_SECRET" | "SUPABASE_BRIDGE_HMAC_SECRET" | "RENDER_WORKER_URL" | "RENDER_WORKER_HMAC_SECRET" | "PRODIGI_API_KEY">> {}
}
