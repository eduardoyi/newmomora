...
process.env.RENDER_WORKER_URL ??= 'https://render-worker.test';
process.env.RENDER_WORKER_HMAC_SECRET ??= 'test-render-worker-secret';
    ...
    cloudflareTest({
      ...
      miniflare: {
        bindings: {
          ...
          RENDER_WORKER_URL: 'https://render-worker.test',
          RENDER_WORKER_HMAC_SECRET: 'test-render-worker-secret',
