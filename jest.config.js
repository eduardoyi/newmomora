module.exports = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/supabase/functions/', '/supabase/scripts/', '/cloudflare/memory-illustration-worker/test/', '/cloudflare/memory-book-worker/test/', '/cloudflare/memory-book-web/test/', '/cloudflare/momora-export-worker/test/', '/workers/memory-viewer/', '/book-renderer/'],
  moduleNameMapper: {
    '^@/(.*)$': '<rootDir>/src/$1',
