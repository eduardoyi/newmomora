module.exports = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/supabase/functions/', '/supabase/scripts/', '/cloudflare/memory-illustration-worker/test/', '/cloudflare/momora-export-worker/test/', '/book-renderer/'],
  moduleNameMapper: {
    '^@/(.*)$': '<rootDir>/src/$1',
