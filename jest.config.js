module.exports = {
  ...
  testPathIgnorePatterns: ['/workers/kindle-frame/', '/node_modules/', '/supabase/functions/', '/supabase/scripts/', '/cloudflare/memory-illustration-worker/test/', '/cloudflare/momora-export-worker/test/'],
  moduleNameMapper: {
    '^@/(.*)$': '<rootDir>/src/$1',
