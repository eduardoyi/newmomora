...
// V5a "part B": the pure outline-generation pieces moved to a
// runtime-agnostic shared module (see eval-memory-book-outline.ts's own
// header comment on the import from '../functions/_shared/memory-book-outline.ts').
import {
